...
Date: October, 2021
This script holds the config data for API
"""
...
FEATURES = {
    ...
    "capital_gain": "Capital gain of the person - numerical - int",
    "capital_loss": "Capital loss of the person - numerical - int",
    "hours_per_week": "Hours of work per week of the person - numerical - int",
    "native_country": "Native country of the person - nominal categorical - str"
}
