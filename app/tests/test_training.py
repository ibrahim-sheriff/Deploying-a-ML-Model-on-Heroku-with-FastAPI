...
def test_model_evaluation():
    ...
    assert pre_train > 0.85, "Train precision should be above 0.85"
    assert rec_train > 0.85, "Train recall should be above 0.85"
    assert f1_train > 0.82, "Train f1 should be above 0.85"

    assert pre_test > 0.82, "Test precision should be above 0.82"
    assert rec_test > 0.82, "Test recall should be above 0.82"
    assert f1_test > 0.80, "Test f1 should be above 0.80"
